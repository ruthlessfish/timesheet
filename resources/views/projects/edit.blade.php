    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form id="edit-project-form" action="{{ route('projects.update', $project) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <select name="client_id" id="client_id" required
                                    ...
                                    <option value="{{ $client->id }}" {{ old('client_id', $project->client_id) ==
                                        $client->id ? 'selected' : '' }}>
                                        {{ $client->name }}
                                    </option>
                                    @endforeach
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $project->description) }}</textarea>
                                @error('description')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select name="status" id="status" required
                                    ...
                                    <option value="cancelled" {{ old('status', $project->status) == 'cancelled' ?
                        ...
                        <div class="mt-6 flex justify-between space-x-3">
                            ...
                            <div>
                                ...
                                <x-primary-button type="submit" form="edit-project-form">
                                    Update Project
                                </x-primary-button>
                            </div>
                        </div>
