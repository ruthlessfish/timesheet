            ...
            <div class="bg-blue-50 border-2 border-blue-400 rounded-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-blue-600 mt-1">{{ $activeTimer->description }}</p>
                        @endif
                        <p class="text-sm text-blue-600 mt-2">Started: {{ $activeTimer->start_time->format('M d, Y g:i A') }}</p>
                        <p class="text-sm text-blue-600">Duration: <span id="timer-duration">{{ $activeTimer->start_time->diffForHumans(null, true) }}</span></p>
                    </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        ...
                                        <br>
                                        <span class="text-xs text-gray-500">{{ $entry->start_time->format('g:i A') }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">{{ $entry->project->client->name }}</div>
                                        <div class="text-sm text-gray-500">{{ $entry->project->name }}</div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        ...
                                        @else
                                            <span class="text-blue-600 font-semibold">Running...</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-4 text-center text-gray-500">
                                        No time entries found. <a href="{{ route('time-entries.create') }}" class="text-blue-600 hover:text-blue-800">Add your first time entry</a>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
