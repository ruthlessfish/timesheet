            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="mb-6 bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                        ...
                        <div class="space-y-2 max-h-48 overflow-y-auto">
                            ...
                            <div class="text-sm text-gray-600 dark:text-gray-400 flex justify-between">
                                <span>{{ $entry->start_time->format('M d, Y') }} - {{ $entry->project->client->name }} / {{ $entry->project->name }}</span>
                    ...
                    <form method="POST" action="{{ route('time-entries.bulk-update') }}" class="space-y-6">
                        ...
                        <!-- Billable Status -->
                        <div>
                            <label for="is_billable" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
