                    ...
                    <form action="{{ route('time-entries.import') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div
                                ...
                                <a href="{{ route('time-entries.index') }}"
                                    class="bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 px-4 py-2 rounded">
                                    Cancel
                                </a>
                                <button type="submit"
                                    class="bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-600 text-white px-6 py-2 rounded inline-flex items-center">
