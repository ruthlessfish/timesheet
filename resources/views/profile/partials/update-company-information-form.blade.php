<section>
    ...
    <div class="mt-6">
        ...
        <div class="space-y-4 mb-6">
            ...
            <div
                class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 {{ $company->is_default ? 'bg-indigo-50 dark:bg-indigo-900/10 border-indigo-300 dark:border-indigo-700' : '' }}">
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex items-center gap-2 ml-4">
                        ...
                        @if(!$company->is_default)
                        <form method="POST" action="{{ route('profile.company.set-default', $company) }}"
                            class="inline">
                            @csrf
                            @method('PATCH')
                            <button type="submit"
                        ...
                        <form method="POST" action="{{ route('profile.company.destroy', $company) }}" class="inline"
        ...
        <x-primary-button type="link" href="{{ route('profile.company.create') }}">
