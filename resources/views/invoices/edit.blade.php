                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-md">
                                ...
                                <div class="text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    <p class="font-semibold text-gray-900 dark:text-gray-100">Total: ${{ number_format($invoice->total, 2) }}</p>
                                </div>
                            </div>
                        </div>

                        <div class="mt-6 flex justify-end space-x-3">
                            <a href="{{ route('invoices.show', $invoice) }}" class="bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 px-4 py-2 rounded">
                                Cancel
                            </a>
